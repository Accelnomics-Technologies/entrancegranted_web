...
async function extractTextFromImage(photo) {
    // Read the image file
...
async function getJSONFromImage(imagePath) {
    try {
        var extractedText = await extractTextFromImage(imagePath);
...
module.exports = {
    getJSONFromImage: getJSONFromImage
};