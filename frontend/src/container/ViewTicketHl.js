...
const ViewTicketHl = ({ open, onClose, styles }) => {
  const handleClose = () => {
    onClose()
  }
  ...
  return (
    <div className='flex gap-4'>
      <Dialog
        ...
        className='modal_boxpanel view_ticketbox view_ticketboxhl'
      >
        ...
        <div dividers={scroll === 'body'} className='viewticket_modal'>
          <form onSubmit={e => e.preventDefault()}>
            {cardData.map((card, index) => (
              <>
                <Card
                  className={`${styles.ticketcard_hl} ${styles.viewticketcard_hl}`}
                    ...
                    <Grid container spacing={12}>
                      <Grid item xs={12} md={18} lg={12}>
                        ...
                        <Grid sx={{ display: 'flex', marginTop: '15px' }}>
                          ...
                          >
                            <IconButton edge='end' style={{ paddingBottom: '0' }}>
                      ...
                      <Grid
                        item
                        container
                        className={styles.vr_imgcol}
                        style={{
                          padding: '20px !important'
                        }}
                      >
                        <div className={styles.ticket_img} style={{ margin: '-20px auto 15px' }}>
